...
- **Integration Pattern:** API-only service (no frontend) - designed to be consumed by MuleSoft Experience/Process APIs
...
### 12.1 Reference Data
- [ ] Questionnaire endpoint returns complete 15-question assessment
- [ ] Risk categories endpoint returns all 5 categories with allocations
- [ ] Risk factors endpoint returns all 10 factors
- [ ] Benchmarks endpoint returns all 5 benchmarks
- [ ] Health endpoint returns correct status

### 12.2 Entity APIs
- [ ] All CRUD operations working for investors
- [ ] Assessments can be created and scored
- [ ] Profiles are generated from assessments
- [ ] Scores are recorded from analysis
- [ ] Scenarios can be retrieved and modified
- [ ] Recommendations can be updated

### 12.3 Analysis APIs
- [ ] Portfolio risk endpoint calculates all metrics correctly
- [ ] Concentration endpoint identifies all limit breaches
- [ ] Suitability endpoint compares portfolio vs profile correctly
- [ ] Stress test endpoint applies scenario shocks correctly
- [ ] Comprehensive endpoint aggregates all analyses

### 12.4 Risk Engine Calculations
- [ ] Portfolio volatility calculation accurate
- [ ] Beta calculation accurate
- [ ] VaR calculations accurate (95% and 99%)
- [ ] Sharpe ratio calculation accurate
- [ ] Herfindahl index calculation accurate
- [ ] Stress test impact calculations accurate

### 12.5 Seed Data
- [ ] 50 investors loaded matching Portfolio system customers
- [ ] 50 risk profiles generated
- [ ] 50 assessments with responses
- [ ] 10 scenarios loaded
- [ ] All reference data loaded

### 12.6 Deployment
- [ ] Docker build succeeds
- [ ] Heroku deployment works on port 3002
